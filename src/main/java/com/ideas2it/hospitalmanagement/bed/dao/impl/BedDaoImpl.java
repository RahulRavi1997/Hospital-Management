...
/**
 * BedDaoImpl is the dao class implements the bedDao interface and
 * it is processing all the interface methods and this class is having its own
 * method to fetch the bedallocation details of the visit.
 * <p>
 * It is having the data manipulation methods like Add, Modify, Remove,
 * Search and Display the details in the Database implements the BedDao
 * interface functions.
 * </p>
