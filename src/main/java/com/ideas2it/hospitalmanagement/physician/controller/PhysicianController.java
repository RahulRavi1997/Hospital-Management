...
public class PhysicianController {
    ...
    private ModelAndView createPhysician(@ModelAttribute final Physician physician, final Model model,
    ...
    @RequestMapping(value = "/displayPhysiciansBySpecialisation", produces = { "application/json",
    ...
    private @ResponseBody String displayPhysiciansBySpecialisation(final Model model,
            @RequestParam("specialisationName") final String specialisation) {
        try {
