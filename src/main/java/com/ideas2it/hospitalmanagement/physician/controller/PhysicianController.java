...
public class PhysicianController {
    ...
    private @ResponseBody String displayPhysiciansBySpecialisation(Model model,
        ...
        try {
        	return new Gson().toJson(physicianService.retrievePhysiciansBySpecialisation(specialisation));        	//List<Physician> physicians = physicianService.retrievePhysiciansBySpecialisation(specialisation);        
