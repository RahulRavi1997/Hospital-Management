...
/**
 * Visit class is the Entity class is having the getters and setter methods which monitors Patient
 * Visit to the Hospital.This class acts as an Model for the Visit Details of an Patient.
 *
 * @author Arul Murugan
 * @version 1.0
 */
