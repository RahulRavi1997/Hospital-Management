...
public interface VisitService {
    ...
    /**
     * <p>
     * This Method is used if a user wants to Add visit Details.
     * It gets the visit object which contains all the information about
     * the visit that needs to be added.
     * </p>
     *
     * @param  visit visit object type contains the visit details
     *                  that needs to be added.
     * @return boolean returns true when visit object added successfully and
    ...
    /**
     * <p>
     * Method to modify the Existing visit Details with new details.The
     * visit Id is searched by using searchvisitById method and
     * the details are modified.
     * </p>
     *
     * @param  visit  visit object contains the New visit details that
     *                   that is modified in old visit.
     * @return boolean  returns true when the visit object is modified and
     *                  false if modification operation is failed.
     * @exception throws Application Exception when the visit Object is not
     *            updated due to any connection error or visit Id not found.
     */
    ...
    /**
     * <p>
     * This Method is used to get all the visit Details that were
     * stored. It gives the visit details as an List.
     * </p>
     *
     * @return List with visit datatype containing visit details.
     * @exception throws Application Exception when the visit details cannot
     *            be retrieved due to any connection error or visit not found.
     */
