	...
	<div id="wrapper">
		<div id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li><a href="searchVisitByPatientId">Visit </a></li>
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><c:out value="${visit.admitDate}" /></td>
							<c:if test="${INPATIENT == visit.patientType}">
								<td><c:out value="${visit.dischargeDate}" /></td>
							</c:if>
							<td><c:out value="${visit.patientType}" /></td>
						</tr>
					</tbody>
				</table>
				<table class="table">
					...
					<tbody>
						<tr>
							<td><c:out value="${visit.patient.id}" /></td>
							<td><c:out
									value="${visit.patient.firstName} ${visit.patient.lastName}" />
							</td>
							<td><c:out value="${visit.patient.emailId}" /></td>
							<td><c:out value="${visit.patient.gender}" /></td>
							<td><c:out value="${visit.patient.mobileNumber}" /></td>
						</tr>
					</tbody>
				</table>
				<table class="table">
					...
					<tbody>
						<tr>
							<td><c:out value="${visit.physician.id}" /></td>
							<td><c:out
									value="${visit.physician.firstName} ${visit.physician.lastName}" />
							</td>
							<td><c:out value="${visit.physician.email}" /></td>
							<td><c:out value="${visit.physician.mobileNumber}" /></td>
							<td><c:out value="${visit.physician.specialisation}" /></td>
						</tr>
					</tbody>
				</table>
			</div>
